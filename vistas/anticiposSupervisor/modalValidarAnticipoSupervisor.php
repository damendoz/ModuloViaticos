<!-- Modal -->
    <form id="frmValidarAnticipoSupervisor">
    <div class="modal fade" id="modalValidarAnticipoSupervisor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" 
    aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <!--  <div class="row">
            ...
            <div class="row">
              <div class="col-sm-2" style="left: 1083px;bottom:10px;">
